...
class Navigator:
    ...
    def get_move_action(self, state_tracker: StateTracker,agent_loc):
        ...
        route = self.__get_route(state_tracker,agent_loc)
    ...
    def __get_route(self, state_tracker: StateTracker,agent_loc):
